...
parser.add_argument('--model_dir',      dest='model_dir',       type=str,            default=r'/home/dev/python/experiments/checkpoint/experiment_15_batch_8',
                    help='directory that saves the model checkpoints')
# parser.add_argument('--model_dir',      dest='model_dir',       type=str,            default=r'/home/dev/python/baseline/checkpoint/experiment_0_batch_16',
#                     help='directory that saves the model checkpoints')
parser.add_argument('--batch_size',     dest='batch_size',      type=int,            default=1, 
                    help='number of examples in batch')
parser.add_argument('--source_obj',     dest='source_obj',      type=str,            default=r'/home/dev/python/data/val.obj', 
                    help='the source images for inference')
parser.add_argument('--embedding_ids',                          type=str,            default='0',
                    help='embeddings involved')
parser.add_argument('--save_dir',                               type=str,            default=r'/home/dev/FONT/experiment_15_batch_8/inferred_result',
...
parser.add_argument('--output_gif',     dest='output_gif',      type=str,            default=None, 
...
parser.add_argument('--compare',        dest='compare',         type=int,            default=0, 
...
parser.add_argument('--progress_file',  dest='progress_file',   type=str,            default=r'/home/dev/python/experiments/logs/experiment_15_batch_8/progress', 
